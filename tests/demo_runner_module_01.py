...
def run_module_01_local_demo(write_output: bool = False) -> dict:
    ...
    fastener_decisions: dict[str, dict] = {}
    ...
    output = {
        ...
        "node_results": {
            node_id: {
                ...
                "selected_bolts": fastener_decisions[node_id],
            }
            for node_id, data in node_results.items()
        },
        "fastener_decisions": fastener_decisions,
        "aggregation_result": {
        ...
        "boundary_note": "Local demo only. Not final ERP BOM. No procurement. No warehouse. No ERP/1C. No API/GAS/DB.",
