...
**Module 01 — Create Calculation modal lane:** **Current step:** **Module 01 Create Calculation Modal V1 Planning — DOC ONLY** — **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CREATE_CALCULATION_MODAL_V1_PLANNING.md`**. **Next allowed step:** **Gemini audit** of Create Calculation Modal V1 Planning. **Not active:** modal/HTML/GAS/backend implementation, **`POST /api/module01/calculations/create`**, SQL/migrations, calculation engine. **Sidebar Static Context V1** remains **`LIVE_PASS`** — **`docs/AUDITS/2026-05-07_MODULE_01_SIDEBAR_STATIC_CONTEXT_V1_LIVE_OPERATOR_TEST.md`**.
...
**Module 01 Calculation:** **DOC only:** **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CREATE_CALCULATION_MODAL_V1_PLANNING.md`** (**pending Gemini audit**) — **not** active: Create Calculation implementation, engine; sidebar + create trajectory reference **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_SIDEBAR_TECHNICAL_SPEC.md`**.
...
**Wider product/backend scope:** **Module 01 Sidebar Static Context V1** — **LIVE_PASS**; **Create Calculation Modal V1** — **planning doc pending audit** (implementation **not** active).
