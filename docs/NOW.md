...
**Module 01 Sidebar:** **Current step:** **Module 01 Sidebar Technical Spec — DOC ONLY** — **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_SIDEBAR_TECHNICAL_SPEC.md`**. **Prior:** Sidebar Planning **Gemini PASS / `SIDEBAR_DESIGN_LOCKED`** — **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_SIDEBAR_PLANNING.md`**. **Next allowed step:** **Gemini audit** of Sidebar Technical Spec. **Not active:** HTML/GAS sidebar/modal implementation, Module 01 backend endpoints, calculation engine.
...
**Module 01 Calculation:** **Not active** — implementation; planning/reference: **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CALC_SLICE_01_PLANNING.md`**, **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_SIDEBAR_PLANNING.md`**, **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_SIDEBAR_TECHNICAL_SPEC.md`** — until explicit unlock after tech spec audit + user approval.
...
**Wider product/backend scope:** **Module 01 Sidebar Technical Spec** — DOC ONLY (`docs/ARCHITECTURE/EDS_POWER_MODULE_01_SIDEBAR_TECHNICAL_SPEC.md`); **Sidebar Planning** — **`SIDEBAR_DESIGN_LOCKED`**. **Terminal governance** — **LOCKED**. **Implementation not active** until tech spec audit + explicit task.
