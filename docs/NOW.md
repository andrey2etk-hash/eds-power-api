...
**Next allowed step (governance):** **Module 01 Create Calculation Modal V1** — **SCOPE DEFINITION / DOC ONLY** — **implementation not active** until explicit TASK; use existing planning/spec docs as baseline (**`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CREATE_CALCULATION_MODAL_V1_PLANNING.md`**, **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CREATE_CALCULATION_TECHNICAL_SPEC.md`**).
**Module 01 — Create Calculation lane:** **Module 01 Create Calculation V1** — **`POST /api/module01/calculations/create`**, service + GAS modal + tests — **`docs/AUDITS/2026-05-07_MODULE_01_CREATE_CALCULATION_V1_IMPLEMENTATION.md`**. **GAS fixes:** modal bootstrap — **`docs/AUDITS/2026-05-07_MODULE_01_CREATE_CALCULATION_MODAL_BOOTSTRAP_FIX.md`**; submit UX — **`docs/AUDITS/2026-05-07_MODULE_01_CREATE_CALCULATION_MODAL_SUBMIT_UX_FIX.md`**. **Registry / live:** operator DML **`MODULE01_CREATE_CALCULATION`** + smokes remain **as separately governed** — **not** opened as default implementation lane by this closeout. **Not active:** engineering / KZO calculation engine / BOM / snapshots. **Sidebar Static Context V1** — **`LIVE_PASS`** — **`docs/AUDITS/2026-05-07_MODULE_01_SIDEBAR_STATIC_CONTEXT_V1_LIVE_OPERATOR_TEST.md`**.
