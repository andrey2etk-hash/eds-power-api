...
**Module 01 — Create Calculation modal lane:** **Current step:** **Module 01 Create Calculation Technical Spec — DOC ONLY** — **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CREATE_CALCULATION_TECHNICAL_SPEC.md`**. **Next allowed step:** **Gemini audit** of this technical spec + **operator schema confirmation** (read-only SQL in spec appendix). **Not active:** modal/HTML/GAS/backend implementation, **`POST /api/module01/calculations/create`**, SQL execution by Cursor, migrations. **Planning:** **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CREATE_CALCULATION_MODAL_V1_PLANNING.md`** (**Gemini `PASS` / ready for tech spec — task assumption**). **Sidebar Static Context V1** — **`LIVE_PASS`** — **`docs/AUDITS/2026-05-07_MODULE_01_SIDEBAR_STATIC_CONTEXT_V1_LIVE_OPERATOR_TEST.md`**.
...
**Module 01 Calculation:** **DOC only:** **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CREATE_CALCULATION_TECHNICAL_SPEC.md`** (**pending Gemini audit + schema confirmation**) — **not** active: Create Calculation implementation; planning baseline **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_CREATE_CALCULATION_MODAL_V1_PLANNING.md`**; sidebar reference **`docs/ARCHITECTURE/EDS_POWER_MODULE_01_SIDEBAR_TECHNICAL_SPEC.md`**.
...
**Wider product/backend scope:** **Module 01 Sidebar Static Context V1** — **LIVE_PASS**; **Create Calculation** — **technical spec DOC pending audit/schema confirmation** (implementation **not** active).
