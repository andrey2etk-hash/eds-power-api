...
_Keep governance rows aligned with Postgres; **`calculation_snapshots`** DDL **`supabase/migrations/20260429120000_calculation_snapshots_v1.sql`** — **hosted applied** (**`Stage 8A` LIVE PASS** · **`IDEA-0017` `IMPLEMENTED`**, closeout **`docs/AUDITS/2026-04-30_STAGE_8A_2_1_LIVE_DEPLOY_CALCULATION_SNAPSHOTS.md`**)._
...
| 2 | **`supabase/migrations/20260429120000_calculation_snapshots_v1.sql`** | **`public.calculation_snapshots`** — applies **after** baseline |
...
| --- | --- | --- | --- | --- |
| **`public.calculation_snapshots`** | `snapshots` | **IDEA-0017 `IMPLEMENTED`** (+ **8A.0.1**) | **`product_type` KZO**, **`snapshot_version` KZO_MVP_SNAPSHOT_V1** | Live gate **PASS**: **`SUPABASE_LIVE_VERIFICATION_GATE`**, dossier **`2026-04-30_STAGE_8A_2_1`**, **`STAGE_8A_COMPLETE`**. |
