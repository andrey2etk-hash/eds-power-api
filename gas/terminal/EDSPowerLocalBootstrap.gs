...
function buildEDSPowerTerminalContext_() {
  ...
  const terminalId = scriptProperties.getProperty(EDS_POWER_TERMINAL_ID_PROPERTY) || "";
  ...
  return {
    ...
    client_type: "GAS",
    bootstrap_version: EDS_POWER_BOOTSTRAP_VERSION,
    core_version: typeof EDS_POWER_CORE_VERSION === "string" ? EDS_POWER_CORE_VERSION : "unknown",
